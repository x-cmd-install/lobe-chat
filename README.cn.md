...
合计: **5,202,326** 行代码（覆盖前 5 种语言、共 **15697** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Json | 3,182,875 | 0 | 0 | 1474 |
| TypeScript | 1,587,985 | 183,669 | 233,814 | 10443 |
| Tsx | 370,568 | 19,565 | 43,777 | 3701 |
...
- **最新版本**: `v2.2.19-canary.17` (2026-09-20)
- **最近提交**: 2026-09-25
- **Release 含资产**: 20 个

## 流行度

- **Star**: 82,810 · **Fork**: 15,920 · **开放 issue**: 6,512 · **贡献者**: 362

## 累计统计

- **发布数**: 3087 · **已合并 PR**: 8591 · **开放 PR**: 608 · **已关闭 issue**: 6143 · **开放 issue**: 369 · **提交数**: 14022

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-26 | 60 | 0 | 0 | 0 | 0 | 0 |
| last60d | 2026-07-27 | 100 | 0 | 0 | 0 | 0 | 0 |
...
_数据快照: `data/card/260925.yml` · 2026-09-25T05:24:26Z._
