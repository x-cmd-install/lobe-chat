...
合计: **5,261,312** 行代码（覆盖前 5 种语言、共 **15801** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Json | 3,224,096 | 0 | 0 | 1476 |
| TypeScript | 1,602,783 | 185,710 | 236,030 | 10521 |
| Tsx | 373,477 | 19,789 | 44,091 | 3724 |
| Yaml | 42,065 | 2,031 | 2,328 | 20 |
| JavaScript | 6,474 | 488 | 690 | 60 |
...
- **最新版本**: `v2.2.19-canary.23` (2026-09-20)
- **最近提交**: 2026-09-26
- **Release 含资产**: 20 个

## 流行度

- **Star**: 82,832 · **Fork**: 15,922 · **开放 issue**: 6,515 · **贡献者**: 362

## 累计统计

- **发布数**: 3088 · **已合并 PR**: 8655 · **开放 PR**: 598 · **已关闭 issue**: 6145 · **开放 issue**: 370 · **提交数**: 14086

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 55 | 0 | 0 | 0 | 0 | 0 |
...
_数据快照: `data/card/260926.yml` · 2026-09-26T05:18:18Z._
