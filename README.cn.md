...
合计: **4,802,791** 行代码（覆盖前 5 种语言、共 **15142** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Json | 2,871,078 | 0 | 0 | 1427 |
| TypeScript | 1,509,641 | 172,290 | 224,304 | 9991 |
| Tsx | 361,949 | 18,449 | 42,931 | 3647 |
| Yaml | 41,917 | 2,003 | 2,320 | 19 |
| JavaScript | 6,282 | 461 | 662 | 58 |
...
- **最新版本**: `v2.2.18-canary.13` (2026-09-11)
- **最近提交**: 2026-09-15
- **Release 含资产**: 20 个

## 流行度

- **Star**: 82,480 · **Fork**: 15,880 · **开放 issue**: 6,499 · **贡献者**: 361

## 累计统计

- **发布数**: 3073 · **已合并 PR**: 8613 · **开放 PR**: 575 · **已关闭 issue**: 6138 · **开放 issue**: 361 · **提交数**: 13776

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-16 | 93 | 0 | 0 | 0 | 0 | 0 |
...
_数据快照: `data/card/260915.yml` · 2026-09-15T05:34:03Z._
